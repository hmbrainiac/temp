...
public class ProductCart implements Serializable{
    ...
    public ProductCart(int produce_id, double inCart, String uuid, String unique_code, String name, String produce_type, String created_at, String updated_at, String file_name, String description, String price_per_kg, String file_blob, double incremental, String measurement, String measurement_full, int category_id) {
    ...
    public ProductCart(int produce_id, double inCart, String uuid, String unique_code, String name, String produce_type, String created_at, String updated_at, String file_name, String description, String price_per_kg, String file_blob, double incremental, String measurement, int category_id) {
        this.produce_id = produce_id;
        this.inCart = inCart;
        this.uuid = uuid;
        this.unique_code = unique_code;
