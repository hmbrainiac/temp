...
public class ProductEmpty implements Serializable {
  ...
  `file_blob` longtext,
    ...
    * */
    ...
    public ProductEmpty(int produce_id, String uuid, String unique_code, String name, String produce_type, String created_at, String updated_at, String file_name, String description, String price_per_kg, String file_blob, double incremental, String measurement, int category_id) {
