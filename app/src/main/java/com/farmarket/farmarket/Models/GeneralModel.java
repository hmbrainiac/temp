...
public class GeneralModel {
    ...
    public GeneralModel(int produce_id, double inCart, String uuid, String unique_code, String name, String produce_type, String created_at, String updated_at, String file_name, String description, String price_per_kg, String file_blob) {
