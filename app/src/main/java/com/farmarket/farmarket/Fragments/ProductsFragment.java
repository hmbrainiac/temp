...
public class ProductsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new MultiCustomAdapter(getContext(), getActivity() ,albumList);

        recyclerView = (RecyclerView) view.findViewById(R.id.recycler_view);

        albumList = new ArrayList<>();
        albumList1 = new ArrayList<>();
        adapter = new MultiCustomAdapter(getActivity(), getActivity() ,albumList);
    ...
    void decideLoad()
    {
        ...
        albumList.clear();
        if(MainActivity.categories.get(MainActivity.viewPager.getCurrentItem()).getName().equalsIgnoreCase("All"))
        {
            loadProducts();
        }
        else
        {
            currentPosition = MainActivity.categories.get(MainActivity.viewPager.getCurrentItem()).getCategory_id();
    ...
    public void onResume() {
        super.onResume();
        mShimmerViewContainer.startShimmerAnimation();
        currentPosition = MainActivity.viewPager.getCurrentItem();
        mSwipeRefreshLayout.setRefreshing(false);
        decideLoad();
